...
var Cell = {
  ...
  renderDefaultCell: function renderDefaultCell(h, params) {
    ...
    }, editRender && (0, _util.eqCellNull)(cellValue) ? [// 如果设置占位符
    h('span', {
  ...
  renderExpandCell: function renderExpandCell(h, params) {
    ...
    }, slots.default ? $table.callSlot(slots.default, params, h) : _xeUtils.default.get(row, labelField)) : null];
  },
  ...
  renderEditHeader: function renderEditHeader(h, params) {
    ...
    }) : null, (0, _tools.isEnableConf)(editRender) && editOpts.showIcon ? h('i', {
  ...
  renderRowEdit: function renderRowEdit(h, params) {
    ...
    return Cell.runRenderer(h, params, this, (0, _tools.isEnableConf)(editRender) && actived && actived.row === params.row);
  },
  ...
  renderCellEdit: function renderCellEdit(h, params) {
    ...
    var editRender = column.editRender;
    var actived = $table.editStore.actived;
    return Cell.runRenderer(h, params, this, (0, _tools.isEnableConf)(editRender) && actived && actived.row === params.row && actived.column === params.column);
  },
